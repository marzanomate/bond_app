...
if df_tamar_raw.empty:
    ...
    tamar_tem_txmj8 = hybrid_tamar_tem(tamar_avg_pct_na_txmj8, tamar_hoy + 3,   datetime(2026, 5,15), datetime(2028, 6,30))
...
def _summarize_tamar_with_spread(objs):
    ...
    for o in objs:
        ...
        rows.append({
            ...
            "Spread vs TAMAR EA (pp)": round(((1+irr/100)/(1+tamar_ea_actual/100)-1)*100, 2) if np.isfinite(irr) and np.isfinite(tamar_ea_actual) else np.nan,
...
def main():
    ...
    if page == "Bonos HD":
        ...
        dlk_rows = [
            ...
            ("D31L6", "29/05/2026", "31/07/2026", "Dolar Linked"),
        ...
        try:
            tamar_rows = [
                ...
                ("TXMD8","15/12/2028","12/6/2026" , tamar_tem_txmd8, "TAMAR"),
